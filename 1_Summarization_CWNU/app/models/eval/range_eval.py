...
if __name__=='__main__':
    ...
    if 'token-em' in task:
        ...
        gold = new_gold.copy()
        pred = new_pred.copy()
        gold = [['O' if y =='I-'+'0'*len(label_dict) else 'I-A' for y in x] for x in gold]
        pred = [['O' if y =='I-'+'0'*len(label_dict) else 'I-A' for y in x] for x in pred]
        ...
        gold = new_gold.copy()
        pred = new_pred.copy()
        gold = [[y if y =='O' else 'I-A' for y in x] for x in gold]
        pred = [[y if y =='O' else 'I-A' for y in x] for x in pred]
